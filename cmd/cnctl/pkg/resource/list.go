...
const annotation = "cli.sigs.k8s.io/cli.v1alpha1.ResourceCommandList"

// ListCommands fetches the list of dynamic commands published as Annotations on CRDs
func ListCommands(client v1beta1client.CustomResourceDefinitionInterface) (v1alpha1.ResourceCommandList, error) {
	cmds := v1alpha1.ResourceCommandList{}
	...
	for _, crd := range crds.Items {
		...
		l := v1alpha1.ResourceCommandList{}
		...
		if reflect.DeepEqual(l, v1alpha1.ResourceCommandList{}) {
